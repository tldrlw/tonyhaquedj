...
#
# Usage:
#   ./update_bpm.sh <TRACK_ID> <NEW_BPM> [PROJECT_ID] [DATASET] [TABLE]
#
# Example:
#   ./update_bpm.sh 22181390 134
#
# Default fallbacks:
...
#
# What it does:
#   1. Shows the current row (track_id, track_name, artists, bpm)
#   2. Updates bpm
...
if [ $# -lt 2 ]; then
  echo "❌ Usage: $0 <TRACK_ID> <NEW_BPM> [PROJECT_ID] [DATASET] [TABLE]"
  exit 1
fi
